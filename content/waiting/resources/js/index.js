...
const EARLIER_PRIORITY_DATE_MOMENT = moment(DATA_SET["2019"].September, DATE_FORMAT);
const LATEST_PRIORITY_DATE_MOMENT = moment(DATA_SET["2020"].October, DATE_FORMAT);
